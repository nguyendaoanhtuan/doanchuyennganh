...
namespace HTQuanLyHoSoSucKhoe.Migrations
{
    ...
    [Migration("20241224152350_updatever4")]
    partial class updatever4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HTQuanLyHoSoSucKhoe.Models.PhieuKetQua", b =>
                {
                    ...
                    b.Property<string>("duongDanFile1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("duongDanFile2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("duongDanFile3")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("phieu_ket_quas", (string)null);
                });
            ...
            modelBuilder.Entity("HTQuanLyHoSoSucKhoe.Models.PhieuChiDinh", b =>
                {
                    ...
                    b.HasOne("HTQuanLyHoSoSucKhoe.Models.Appointment", "Appointment")
                        .WithMany("PhieuChiDinhs")
